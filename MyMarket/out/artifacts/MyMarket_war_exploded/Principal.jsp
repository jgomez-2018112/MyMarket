...
<nav>
    <div class="logo">
        ...
        <div class="btn-user">
            <div class="dropdown">
                <button id="dropdownMenuButton" class="dropdown btnUser" type="button" data-toggle="dropdown"
                ...
                <div class="dropdown-menu text-center" aria-labelledby="dropdownMenuButton">
                    ...
                    <form class="responsive-form" action="Validar" method="POST">
                        <button style="color: red" name="accion" name="Salir" class="btn btn-danger dropdown-item"
                                href="#">Salir
                        </button>
                    </form>
                </div>
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-content">
                <ul class="lists">
                    ...
                    <li class="list">
                        <a href="Controlador?menu=Facura&accion=Listar" target="myFrame" class="nav-link">
